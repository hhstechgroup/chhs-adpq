...
import com.engagepoint.cws.apqd.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.engagepoint.cws.apqd.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.engagepoint.cws.apqd.repository.search")
