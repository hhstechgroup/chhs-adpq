...
import com.engagepoint.cws.apqd.config.*;

import com.engagepoint.cws.apqd.config.Constants;
...
@EnableConfigurationProperties({ JHipsterProperties.class, LiquibaseProperties.class, ContentProperties.class, UspsProperties.class})
